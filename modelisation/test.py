...
comparer_groupes_mannwhitney(joueurs, seuil_force=0.6, systeme="elo")
comparer_groupes_mannwhitney(joueurs, seuil_force=0.6, systeme="glicko")
comparer_groupes_mannwhitney(joueurs, seuil_force=0.6, systeme="glicko2")
